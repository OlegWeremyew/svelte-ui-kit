<script>
	...
	import { t } from '@/utils';
	import { splide } from '@/store/state.ts';
  ...
  .images {
      ...
      .image-wrapper {
        ...
        .around {
          ...
          .small-image {
            ...
            &--1 {
              background-image: url(../images/icons/round-icon-1.png);
              background-size: cover;
              background-position: center;
              background-repeat: no-repeat;
            }
            ...
            &--2 {
              background-image: url(../images/icons/round-icon-2.png);
              background-size: cover;
              background-position: center;
              background-repeat: no-repeat;
            }
            ...
            &--3 {
              background-image: url(../images/icons/round-icon-3.png);
              background-size: cover;
              background-position: center;
              background-repeat: no-repeat;
            }
    ...
    .alone-images {
      ...
      .big-img {
        width: 100%;
        height: 100%;
        background-image: url(../images/icons/round-icon-big.png);
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
        transform: scale(1.3);
